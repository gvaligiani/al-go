...
func TestDifferenceInt64(t *testing.T) {
	...
	testCases := map[string]TestCase{
		...
		"intersection": {
			...
			wantItems: set.New[int64](1, 3, 4, 6),
		},
		"included": {
			left:      set.New[int64](1, 2, 3),
			right:     set.New[int64](2),
			wantItems: set.New[int64](1, 3),
		},
		"no-intersection": {
			left:      set.New[int64](1, 2, 3),
	...
	test.RunTestCases(t, testCases, func(t *testing.T, logger *zap.Logger, testCase TestCase) {
		...
		// execute
		gotItems := set.Difference(testCase.left, testCase.right)
...
func TestDifferenceStruct(t *testing.T) {
	...
	testCases := map[string]TestCase{
		...
		"intersection": {
			...
			wantItems: set.New(Item{Value: 1}, Item{Value: 3}, Item{Value: 4}, Item{Value: 6}),
		},
		"included": {
			left:      set.New(Item{Value: 1}, Item{Value: 2}, Item{Value: 3}),
			right:     set.New(Item{Value: 2}),
			wantItems: set.New(Item{Value: 1}, Item{Value: 3}),
		},
		"no-intersection": {
			left:      set.New(Item{Value: 1}, Item{Value: 2}, Item{Value: 3}),
...
func TestDifferenceStructPointer(t *testing.T) {
	...
	test.RunTestCases(t, testCases, func(t *testing.T, logger *zap.Logger, testCase TestCase) {
		...
		// execute
		gotItems := set.DeepDifference(testCase.left, testCase.right)
